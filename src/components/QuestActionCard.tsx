  ...
  return (
    <article className='flex h-full flex-col justify-between rounded-lg border border-[#2E3139] bg-[#1E2025] px-6 pb-3 min-[768px]:px-4'>
      <div>
        ...
        <h3 className='mt-3 font-alumni font-semibold text-[32px] uppercase leading-none'>
          {title}
        </h3>
      ...
      <button
        className='mt-4 flex h-8 w-full items-center justify-center gap-2 rounded-full bg-[#FDFDFD] px-4 font-alumni font-semibold text-[24px] uppercase leading-none text-[#20232a] transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-[0_12px_24px_rgba(0,0,0,0.28)] cursor-pointer'
        type='button'
      >
        <span>{button}</span>
        {actionIcon ? (
