      ...
      <div className='hidden w-full items-center justify-between gap-4 min-[1025px]:flex'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className='relative shrink-0'>
            <button
              className='inline-flex h-12 w-28 cursor-pointer items-center justify-center gap-2 rounded-full border-0 bg-transparent p-0 font-kelly leading-none text-[20px] text-[#F6F2EA] transition-all duration-200 hover:bg-white/6 hover:text-white'
              type='button'
